...
class ArxivBot(telepot.Bot):
	...
	#
	#  @param self The object pointer
	#  @param conn_db The connection object (see psycopg2 documentation)
	def set_connection_database(self, conn_db):

		## The database connection object
		self.connection_database = conn_db

	## This method allows for the injection of the cursor object needed to operate over the database
	#
	#  @param self The object pointer
	#  @param pref_tbl The cursor object generated by the connection class (see psycopg2 documentation)
	def set_cursor_database(self, cur_db):

		## The database cursor object
		self.cursor_database = cur_db
